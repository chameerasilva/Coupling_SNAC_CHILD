...
public:
  ...
  tMesh( const tInputFile &, int nox, int noy, double*** points, bool checkMeshConsistency );
  tMesh( const tInputFile &, const int npts, std::vector<double *> &pts, std::vector<int> &bmarker, bool checkMeshConsistency );
  tMesh( tMesh const * );
  ...
  void MakeMeshFromPoints( const tInputFile &, int nox, int noy, double*** pts ); // creates mesh from list of pts
  void MakeMeshFromPoints( const tInputFile &, const int num_points, std::vector<double *> &pts, std::vector<int> &bdy_marker);

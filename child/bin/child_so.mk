...
OBJECTS = \
 ...
 predicates.$(OBJEXT) tVegetation.$(OBJEXT) \
 tListInputData.$(OBJEXT) \
 ...
 tIDGenerator.$(OBJEXT) tWaterSedTracker.$(OBJEXT) tLithologyManager.$(OBJEXT)

#childmain.$(OBJEXT) 
#tRadiation.$(OBJEXT) 
#tSoilMoisture.$(OBJEXT) 
...
#tRadiation.$(OBJEXT): $(PT)/tRadiation/tRadiation.cpp
#	$(CXX) $(CFLAGS) $(PT)/tRadiation/tRadiation.cpp

#tSoilMoisture.$(OBJEXT): $(PT)/tSoilMoisture/tSoilMoisture.cpp
#	$(CXX) $(CFLAGS) $(PT)/tSoilMoisture/tSoilMoisture.cpp
...
#	$(PT)/tRadiation/tRadiation.h \
#	$(PT)/tSoilMoisture/tSoilMoisture.h \
...
#tRadiation.$(OBJEXT): $(HFILES)
#tSoilMoisture.$(OBJEXT): $(HFILES)
